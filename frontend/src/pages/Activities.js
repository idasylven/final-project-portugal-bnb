        ...
        <div className="act-container">
          ...
          <div className="act-box-left">
            <div className="act-wrapper">
              ...
              <a href="/some/valid/uri" className="act-link">Check them out</a>
            </div>
            <img className="act-img" src="/assets/images/surf.jpg" alt="surfer"></img>
          </div>
          <div className="act-box-right">
            <div className="act-wrapper">
              ...
              <p className="act-text">
                ...
                <a href="/some/valid/uri" className="act-link">Here they are</a>
            </div>
            <img className="act-img" src="/assets/images/surfboards.jpg" alt="surf-boards"></img>
          </div>
            <div className="act-box-left">
              <div className="act-wrapper">
                ...
                <p className="act-text">
                  ...
                  <a href="/some/valid/uri" className="act-link"> Explore the city guide here</a>
              </div>
              <img className="act-img" src="/assets/images/city-house.jpg" alt="House in the city"></img>
            </div>
          <div className="act-box-right">
            <div className="act-wrapper">
              ...
              <p className="act-text">
                ...
                <a href="/some/valid/uri" className="act-link"> See the different options here</a>
            </div>
            <img className="act-img" src="/assets/images/sup.jpg" alt="paddle-board"></img>
          </div>
          <div className="act-box-left">
            <div className="act-wrapper">
              ...
              <p className="act-text">
                ...
                <a href="/some/valid/uri" className="act-link"> Let's go diving</a>
            </div>
            <img className="act-img" src="/assets/images/diving.jpg" alt="scuba diving in ocean"></img>
          </div>
          <div className="act-box-right">
            <div className="act-wrapper">
              ...
              <p className="act-text">
                ...
                <a href="/some/valid/uri" className="act-link"> See the Stormy Sailing club here </a>
            </div>
            <img className="act-img" src="/assets/images/sail.jpg" alt="sail boat"></img>
          </div>
          <div className="act-box-left">
            <div className="act-wrapper">
              ...
              <p className="act-text">
                ...
                Don't forget to bring the camera for that kodak moment!</p>
                <a href="/some/valid/uri" className="act-link"> Haiking maps & guides </a>
            </div>
            <img className="act-img" src="/assets/images/cliffs.jpg" alt="cliffs by the ocean"></img>
          </div>
          <div className="act-box-right">
            <div className="act-wrapper">
              ...
              <p className="act-text"> 
                ...
                and just relax...</p>
                <a href="/some/valid/uri" className="act-link">Bust a beach here</a>
            </div>
            <img className="act-img" src="/assets/images/beach.jpg" alt="beach by cliffs"></img>
          </div>
        </div>
      <Footer />
    </>
