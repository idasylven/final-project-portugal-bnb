      ...
      <h1 className="about-mob-heading">About Us</h1>
        ...
        <div className="about-box-right">
          ...
          <p className="about-text">
            ...
            When you stepp in you will be embraced by their spiritful characters.</p>
            <p>A nice Healthy and fresh breackfast will be served so you just can get out the door and be ready for a day of adventure.
